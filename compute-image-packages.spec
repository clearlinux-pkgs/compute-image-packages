...
Source0  : https://github.com/GoogleCloudPlatform/compute-image-packages/archive/20170718.tar.gz
...
%prep
%setup -q -n compute-image-packages-20170718
...
export LANG=C
export SOURCE_DATE_EPOCH=1500566637
